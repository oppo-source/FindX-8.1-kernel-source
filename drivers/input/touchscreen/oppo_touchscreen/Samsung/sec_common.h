...
struct sec_proc_operations {
    ...
    void    (*set_corner_range)  (void *chip_data, int dir, int corner_bit, int x, int y);
    void    (*get_corner_range)  (void *chip_data, int* p_ver_x, int* p_ver_y, int* p_hor_x, int* p_hor_y);
};
