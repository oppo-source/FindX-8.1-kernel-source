...
#ifdef VENDOR_EDIT
/* Le.Li@PSW.MM.AudioDriver.HeadsetDet, 2018/08/19,
 * Add to dynamic change clk to 100K when as6313 use i2c.
 */
...
#ifdef VENDOR_EDIT
/*xing.xiong@BSP.Kernel.Driver, 2018/05/14, Add for print i2c debug info*/
