		...
		struct msm_vidc_buffer *mbuf)
{
	...
	int i = 0;
    #ifdef VENDOR_EDIT
    //Xiaopeng.Hu@PSW.MM.MediaServer.Player.1518668, 2018/08/15,
    //Add for fix double list_del in rbr event processing.
    u32 planes[VIDEO_MAX_PLANES] = {0};
    #endif /* VENDOR_EDIT */
	...
	list_for_each_entry(temp, &inst->registeredbufs.list, list) {
        #ifndef VENDOR_EDIT
        //Xiaopeng.Hu@PSW.MM.MediaServer.Player.1518668, 2018/08/15,
        //Modify for fix double list_del in rbr event processing.
