...
static void venus_hfi_pm_handler(struct work_struct *work)
{
	...
	#ifndef VENDOR_EDIT
	//Xiaopeng.Hu@PSW.MM.MediaServer.Player.1518668, 2018/08/20,
	//Modify for waiting for vcodec hardware to go into idle state before preparing for power collapse.
	/*
	int count = 0;
	*/
	#else /* VENDOR_EDIT */
