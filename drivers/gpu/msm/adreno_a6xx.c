...
#ifdef VENDOR_EDIT
//wenhua.Leng@PSW.MM.Display.GPU.Stability, add qcom patch to solve OOB issue 20180622
...
#ifdef VENDOR_EDIT
//Zhen.Yue@PSW.MM.Display.GPU, 2018/6/29, Add for QC patch.
		...
		unsigned int boot_state)
{
	...
	switch (boot_state) {
#ifndef VENDOR_EDIT
//Zhen.Yue@PSW.MM.Display.GPU, 2018/6/29, Delete for QC patch.
	case GMU_RESET:
		/* fall through */
#endif /* VENDOR_EDIT */
	case GMU_COLD_BOOT:
...
#ifndef VENDOR_EDIT
//Zhen.Yue@PSW.MM.Display.GPU, 2018/6/29, Modify for QC patch.
