...
#ifdef VENDOR_EDIT
/*jie.hu@PSW.MM.Display.LCD.Stability,2018/5/15,add for hw match*/
...
//#ifdef VENDOR_EDIT
/*jie.hu@PSW.MM.Display.LCD.Stability,2018/1/6,add for lcd power control*/
...
/*jie.hu@PSW.MM.Display.LCD.Stability,2018/5/15,add for hw match*/
/*
 * YongPeng.Yi@PSW.MM.Display.LCD.Stability, 2018/05/17,
...
//#endif /*VENDOR_EDIT*/
//#ifdef VENDOR_EDIT
/*jie.hu@PSW.MM.Display.LCD.Stability,2018/4/10,add a delay here*/
	usleep_range(10000, 10000);
//#endif /*VENDOR_EDIT*/

#ifdef VENDOR_EDIT
/*Jie.Hu@PSW.MM.Display.Lcd.Stability, 2018-05-29,add for solving mipi signal abnormal*/
    if (!panel->lp11_init){
#endif

#ifdef VENDOR_EDIT
/*Jie.Hu@PSW.MM.Display.Lcd.Stability, 2018-06-01,add for match T13 pcb*/
	if((is_project(OPPO_17107) && ((get_PCB_Version() < HW_VERSION__13) ||(get_PCB_Version() == HW_VERSION__14)))
		|| (is_project(OPPO_17127) && (get_PCB_Version() == HW_VERSION__10))) {
#endif
...
#ifndef VENDOR_EDIT
/*jie.hu@PSW.MM.Display.LCD.Stability,2018/3/21,add for oppo display new structure*/
...
#ifdef VENDOR_EDIT
/*jie.hu@PSW.MM.Display.Lcd.Stability,2018/5/26,for lp11_init*/
	panel->lp11_init =
...
/*Jie.Hu@PSW.MM.Display.Lcd.Stability, 2018-03-26,add to mark power states*/
	...
	if (rc)
		pr_err("[%s] failed to send DSI_CMD_SET_LP1 cmd, rc=%d\n",
		       panel->name, rc);
#ifdef VENDOR_EDIT
//*jie.hu@PSW.MM.Display.LCD.Stability,2018/4/3,set and save display status*/
...
#ifdef VENDOR_EDIT
/*Jie.Hu@PSW.MM.Display.Lcd.Stability, 2018-04-5,add to mark power states*/
...
#ifdef VENDOR_EDIT
//*jie.hu@PSW.MM.Display.LCD.Stability,2018/3/21,add for save display panel power status at oppo display management*/
	set_oppo_display_power_status(OPPO_DISPLAY_POWER_ON);
#endif
	mutex_unlock(&panel->panel_lock);
	return rc;
