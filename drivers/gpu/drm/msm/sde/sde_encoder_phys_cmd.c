...
#ifndef VENDOR_EDIT
/*Jie.Hu@PSW.MM.Display.Lcd.Stability, 2018-04-24,add for sove crash issue when esd testing, we think no need to crash here*/
		SDE_DBG_DUMP("panic");
#else /*VENDOR_EDIT*/
		...
		struct sde_encoder_phys *phys_enc)
{
	 ...
	 */
#ifndef VENDOR_EDIT
/*Jie.Hu@PSW.MM.Display.Lcd.Stability, 2018-04-14,add to solve crash issue when panel is disconnect*/
