...
#ifdef VENDOR_EDIT
/* cuixiaogang@SWDP2.OPPOFeature.Hypnus, 2018-03-21, export some symbols */
...
#ifndef VENDOR_EDIT
/*Jie.Hu@PSW.MM.Display.Lcd.Stability, 2018-04-13,add for  export drm_notifier*/
...
#ifdef VENDOR_EDIT
/*Jie.Hu@PSW.MM.Display.Lcd.Stability, 2018-04-13,add for  remove original drm notify*/
