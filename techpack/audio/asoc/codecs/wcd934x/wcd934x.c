...
#ifdef VENDOR_EDIT
//Zhaoan.Xu@PSW.MM.AudioDriver.Codec, 2018/05/31, Add for uart warning issue
static struct snd_soc_codec *wcd94xx_codec_g = NULL;
#endif /* VENDOR_EDIT */
...
#ifndef VENDOR_EDIT
//Zhaoan.Xu@PSW.MM.AudioDriver.Codec, 2018/06/14, Modify for pop noise when start dmic
...
#ifdef VENDOR_EDIT
//Zhaoan.Xu@PSW.MM.AudioDriver.Codec, 2018/05/31, Add for uart warning issue
static int dmic1_highz_enable(u8 enable) {
	if(!wcd94xx_codec_g){
		pr_err("%s:wcd94xx_codec_g is null", __func__);
		return -1;
	}
	pr_info("%s: enter %d", __func__, enable);
	if(enable) {
		snd_soc_update_bits(wcd94xx_codec_g, WCD934X_TEST_DEBUG_PIN_CTL_OE_2, 0x2, 253);
		snd_soc_update_bits(wcd94xx_codec_g, WCD934X_TLMM_DMIC1_CLK_PINCFG, 0x1F, 6);
		snd_soc_update_bits(wcd94xx_codec_g, WCD934X_TEST_DEBUG_PIN_CTL_OE_2, 0x4, 251);
		snd_soc_update_bits(wcd94xx_codec_g, WCD934X_TLMM_DMIC1_DATA_PINCFG, 0x1F, 6);
	} else {
		snd_soc_update_bits(wcd94xx_codec_g, WCD934X_TEST_DEBUG_PIN_CTL_OE_2, 0x4, 255);
		snd_soc_update_bits(wcd94xx_codec_g, WCD934X_TLMM_DMIC1_CLK_PINCFG, 0x1F, 0);
		snd_soc_update_bits(wcd94xx_codec_g, WCD934X_TEST_DEBUG_PIN_CTL_OE_2, 0x2, 255);
		snd_soc_update_bits(wcd94xx_codec_g, WCD934X_TLMM_DMIC1_DATA_PINCFG, 0x1F, 0);
	}
	return 0;
}
EXPORT_SYMBOL(dmic1_highz_enable);
#endif /* VENDOR_EDIT */
