...
{
	NOT_SELF_BTN = 0,
	SELFSTICK_BTN_PLUG_IN = 1,
	SELFSTICK_BTN_SHORT_PRESS = 2,
	SELFSTICK_BTN_LONG_PRESS = 4,
};
#endif /* VENDOR_EDIT */
...
struct wcd_mbhc {
	...
	struct delayed_work usbc_analog_init_dwork;
	#endif /* VENDOR_EDIT */
	...
	//Le.Li@PSW.MM.AudioDriver.Feature.SelfstickDetect, 2018/04/30, add for selfstick detect
	int jack_state;
	int invalid_jack_cound;
	struct extcon_dev selfstick_dev;
	#endif /* VENDOR_EDIT */
	#ifdef VENDOR_EDIT
	//Le.Li@PSW.MM.AudioDriver.HeadsetDet, 2018/05/12, Add for abnormal adapter check
	struct delayed_work usbc_abnormal_adapter_check_dwork;
	#endif /* VENDOR_EDIT */
};

#ifdef VENDOR_EDIT
//Le.Li@BSP.MM.AudioDriver, 2018/04/12, Add for selfstick
static const unsigned int wcd_ext_mbhc_supported_cable[] = {
